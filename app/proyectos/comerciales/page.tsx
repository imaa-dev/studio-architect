...
export default function ComercialesPage() {
  const comerciales = projects.filter(
    (project) => project.category === 'Comercial'
  )
      ...
      <main>
        ...
        <section className="relative flex min-h-[60vh] items-end overflow-hidden">
          <div className="absolute inset-0">
            <img
              src="/images/project-comercial.png"
              alt="Proyectos Comerciales"
          ...
          <div className="relative z-10 mx-auto w-full max-w-7xl px-6 pb-16 pt-28 lg:px-10">
            ...
            <p className="mt-6 max-w-2xl text-lg leading-relaxed text-white/80">
              Diseñamos espacios comerciales y corporativos que fortalecen la
              identidad de cada marca, combinando funcionalidad, experiencia de
              usuario y una arquitectura alineada con sus objetivos.
            </p>
          </div>
        </section>
          ...
          <div className="mx-auto grid max-w-7xl gap-10 px-6 lg:grid-cols-[2fr_1fr] lg:px-10">
            ...
            <Reveal>
              ...
              <h2 className="mt-5 font-display text-4xl font-semibold tracking-tight">
                Espacios comerciales diseñados para conectar marcas y personas.
              </h2>

              <p className="mt-6 max-w-3xl leading-8 text-muted-foreground">
                Desarrollamos oficinas, clínicas y espacios comerciales
                personalizados, creando ambientes eficientes, representativos y
                coherentes con la identidad de cada empresa.
              </p>
            </Reveal>
            ...
            <Reveal delay={100}>
              <div className="rounded-3xl border border-border bg-card p-8">
                ...
                <p className="mt-2 text-muted-foreground">
                  proyectos comerciales desarrollados.
                </p>
            ...
            <div className="grid gap-8 lg:grid-cols-2">
              ...
              {comerciales.map((project, index) => (
                ...
                >
                  ...
                  <Link
                    href={`/proyectos/comerciales/${project.slug}`}
